...
.method public final decompress(Ljava/nio/ByteBuffer;IILjava/nio/ByteBuffer;II)I
    ...
    invoke-virtual/range {v2 .. v8}, Lnet/jpountz/lz4/LZ4JavaUnsafeSafeDecompressor;->decompress([BII[BII)I
...
.method public final decompress([BII[BII)I
    ...
    .line 24
    invoke-static {p4, p5, p6}, Lnet/jpountz/util/UnsafeUtils;->checkRange([BII)V
    ...
    invoke-static {p1, v3}, Lnet/jpountz/util/UnsafeUtils;->readByte([BI)B
    ...
    .line 64
    :cond_8
    invoke-static {p1, v2, p4, v0, v1}, Lnet/jpountz/lz4/LZ4UnsafeUtils;->safeArraycopy([BI[BII)V
    ...
    .line 71
    :cond_9
    invoke-static {p1, v2, p4, v0, v1}, Lnet/jpountz/lz4/LZ4UnsafeUtils;->wildArraycopy([BI[BII)V

    .line 72
    add-int v0, v2, v1

    .line 76
    invoke-static {p1, v0}, Lnet/jpountz/util/UnsafeUtils;->readShortLE([BI)I
    ...
    .line 100
    :cond_e
    invoke-static {p4, v8, v4, v1}, Lnet/jpountz/lz4/LZ4UnsafeUtils;->safeIncrementalCopy([BIII)V

    goto/16 :goto_1

    .line 102
    :cond_f
    invoke-static {p4, v8, v4, v0}, Lnet/jpountz/lz4/LZ4UnsafeUtils;->wildIncrementalCopy([BIII)V
