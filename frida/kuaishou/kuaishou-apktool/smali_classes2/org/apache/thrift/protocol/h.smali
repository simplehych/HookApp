.class public final Lorg/apache/thrift/protocol/h;
...
.method private static a(Lorg/apache/thrift/protocol/e;BI)V
    .locals 4
    ...
    :pswitch_1
    invoke-virtual {p0}, Lorg/apache/thrift/protocol/e;->f()Z

    goto :goto_0

    :pswitch_2
    invoke-virtual {p0}, Lorg/apache/thrift/protocol/e;->g()B

    goto :goto_0

    :pswitch_3
    invoke-virtual {p0}, Lorg/apache/thrift/protocol/e;->h()S

    goto :goto_0

    :pswitch_4
    invoke-virtual {p0}, Lorg/apache/thrift/protocol/e;->i()I

    goto :goto_0

    :pswitch_5
    invoke-virtual {p0}, Lorg/apache/thrift/protocol/e;->j()J

    goto :goto_0

    :pswitch_6
    invoke-virtual {p0}, Lorg/apache/thrift/protocol/e;->k()D

    goto :goto_0

    :pswitch_7
    invoke-virtual {p0}, Lorg/apache/thrift/protocol/e;->m()Ljava/nio/ByteBuffer;

    goto :goto_0

    :goto_1
    :pswitch_8
    invoke-virtual {p0}, Lorg/apache/thrift/protocol/e;->b()Lorg/apache/thrift/protocol/b;
    ...
    :pswitch_9
    invoke-virtual {p0}, Lorg/apache/thrift/protocol/e;->c()Lorg/apache/thrift/protocol/d;
    ...
    :pswitch_a
    invoke-virtual {p0}, Lorg/apache/thrift/protocol/e;->e()Lorg/apache/thrift/protocol/i;
    ...
    :pswitch_b
    invoke-virtual {p0}, Lorg/apache/thrift/protocol/e;->d()Lorg/apache/thrift/protocol/c;
