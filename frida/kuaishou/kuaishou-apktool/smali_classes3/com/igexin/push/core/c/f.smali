...
.method static constructor <clinit>()V
    ...
    const-class v0, Lcom/igexin/push/core/c/f;
...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, Lcom/igexin/push/core/c/f;->a()V
...
.method private c([B)V
    ...
    sget-object v2, Lcom/igexin/push/core/c/f;->a:Ljava/lang/String;

    invoke-virtual {v0, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    const-string/jumbo v2, "|parse sdk config from server resp = "
    ...
    invoke-virtual {v1, v2, v3, v4}, Lcom/igexin/push/core/a/f;->a(IILjava/lang/String;)V
    ...
    :cond_15
    const-string/jumbo v1, "sdk.needlook.enable"
    ...
    invoke-direct {p0, v1}, Lcom/igexin/push/core/c/f;->d([B)V

    :cond_17
    const-string/jumbo v1, "sdk.report.initialize.enable"
    ...
    :cond_1d
    const-string/jumbo v1, "sdk.watchout.app"
    ...
    :cond_1e
    const-string/jumbo v1, "sdk.watchout.service"
    ...
    :cond_1f
    const-string/jumbo v1, "sdk.daemon.enable"
    ...
    :cond_21
    const-string/jumbo v1, "sdk.guardactivity.first"
    ...
    :cond_23
    const-string/jumbo v1, "sdk.guard.blacklist"
    ...
    sput-object v1, Lcom/igexin/push/config/k;->F:Ljava/lang/String;

    :cond_24
    const-string/jumbo v1, "sdk.polling.dis.cnt"
    ...
    :cond_25
    const-string/jumbo v1, "sdk.polling.login.interval"
    ...
    sput-wide v2, Lcom/igexin/push/config/k;->H:J

    :cond_26
    const-string/jumbo v1, "sdk.polling.exit.heartbeat.cnt"
    ...
    :cond_27
    const-string/jumbo v1, "sdk.reset.reconnect.delay"
    ...
    :goto_2
    :try_start_4
    const-string/jumbo v1, "sdk.guard.maxcnt"
    ...
    :goto_3
    :try_start_6
    const-string/jumbo v1, "sdk.httpdata.maxsize"
    ...
    :cond_2a
    const-string/jumbo v1, "sdk.hide.righticon.blacklist"
    ...
    sput-object v1, Lcom/igexin/push/config/k;->K:Ljava/lang/String;

    :cond_2b
    const-string/jumbo v1, "sdk.taskid.blacklist"
    ...
    sput-object v1, Lcom/igexin/push/config/k;->L:Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lcom/igexin/push/core/a/f;->D()V

    :cond_2c
    :goto_4
    const-string/jumbo v1, "sdk.applink.feedback.enable"
    ...
    :cond_2e
    const-string/jumbo v1, "sdk.applink.domains"
    ...
    sput-object v1, Lcom/igexin/push/config/k;->N:Ljava/lang/String;
    ...
    :cond_2f
    const-string/jumbo v1, "sdk.miuipush.enable"
    ...
    :cond_31
    const-string/jumbo v1, "sdk.flymepush.enable"
    ...
    :cond_33
    const-string/jumbo v1, "sdk.hmspush.enable"
    ...
    :cond_35
    const-string/jumbo v1, "sdk.colorospush.enable"
    ...
    :cond_37
    const-string/jumbo v1, "sdk.fcmpush.enable"
    ...
    invoke-virtual {v1, v0}, Lcom/igexin/push/core/a/f;->c(Ljava/lang/String;)V
...
.method public a()V
    ...
    invoke-virtual {p0, v0}, Lcom/igexin/push/core/c/f;->b([B)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public a([B)V
    ...
    invoke-direct {p0, p1}, Lcom/igexin/push/core/c/f;->c([B)V
