...
.method constructor <init>(Landroid/widget/CompoundButton;)V
    ...
    .line 36
    iput-object v1, p0, Landroid/support/v7/widget/h;->a:Landroid/content/res/ColorStateList;

    .line 37
    iput-object v1, p0, Landroid/support/v7/widget/h;->b:Landroid/graphics/PorterDuff$Mode;

    .line 38
    iput-boolean v0, p0, Landroid/support/v7/widget/h;->d:Z

    .line 39
    iput-boolean v0, p0, Landroid/support/v7/widget/h;->e:Z

    .line 51
    iput-object p1, p0, Landroid/support/v7/widget/h;->c:Landroid/widget/CompoundButton;
...
.method private b()V
    ...
    .prologue
    .line 114
    iget-object v0, p0, Landroid/support/v7/widget/h;->c:Landroid/widget/CompoundButton;
    ...
    iget-boolean v1, p0, Landroid/support/v7/widget/h;->d:Z

    if-nez v1, :cond_0

    iget-boolean v1, p0, Landroid/support/v7/widget/h;->e:Z
    ...
    .line 120
    iget-object v1, p0, Landroid/support/v7/widget/h;->a:Landroid/content/res/ColorStateList;
    ...
    .line 123
    iget-object v1, p0, Landroid/support/v7/widget/h;->b:Landroid/graphics/PorterDuff$Mode;
    ...
    .line 128
    iget-object v1, p0, Landroid/support/v7/widget/h;->c:Landroid/widget/CompoundButton;
...
.method final a()V
    ...
    .prologue
    .line 104
    iget-boolean v0, p0, Landroid/support/v7/widget/h;->f:Z
    ...
    iput-boolean v0, p0, Landroid/support/v7/widget/h;->f:Z
    ...
    .line 110
    invoke-direct {p0}, Landroid/support/v7/widget/h;->b()V
...
.method final a(Landroid/content/res/ColorStateList;)V
    ...
    .prologue
    .line 82
    iput-object p1, p0, Landroid/support/v7/widget/h;->a:Landroid/content/res/ColorStateList;
...
.method final a(Landroid/graphics/PorterDuff$Mode;)V
    ...
    .prologue
    .line 93
    iput-object p1, p0, Landroid/support/v7/widget/h;->b:Landroid/graphics/PorterDuff$Mode;
...
.method final a(Landroid/util/AttributeSet;I)V
    ...
    .line 62
    iget-object v2, p0, Landroid/support/v7/widget/h;->c:Landroid/widget/CompoundButton;

    iget-object v3, p0, Landroid/support/v7/widget/h;->c:Landroid/widget/CompoundButton;
